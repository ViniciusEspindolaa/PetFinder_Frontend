...
const HTML = \<div className="flex flex-wrap gap-2 w-full justify-between items-center mt-3">
            ...
            <div className="sm:ml-auto flex flex-wrap gap-2 items-center mt-2 sm:mt-0">
...
c = c.replace(/<div className="mt-2 sm:mt-0 sm:ml-auto flex flex-wrap gap-2">[\s\S]*?<\/div>\s*<\/div>\s*\{showPets && \([\s\S]*?<\/div>\s*\)\}\s*<\/div>/, HTML);
